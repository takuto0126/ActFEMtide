...
!# header
 character(70) :: head    ! header like "polygon"
end type meshpara
...
character(70),optional     :: parafile    ! added on 2016.09.15
...
!read(input,22) g_meshpara%n_layer  !added by tokuma nakaya
