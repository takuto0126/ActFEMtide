...
#[bz] East
gmt basemap -R$wesn -JX10/10 -Bxa50+l"Easting[km]" -Bya50+l"Northing[km]" -BWeSn+t"arg(B east) [deg]" -X-22 -Y-13
awk '{print($1,$2,$5)}' $infile | gmt surface -R$wesn -I$di -Ggrd.grd -T0
gmt grdimage  grd.grd -C -R$wesn
gmt grdcontour topo.grd -C50 -L-40/40 -W1

#[bx] North
gmt basemap -R$wesn -JX10/10 -Bxa50+l"Easting[km]" -Bya50 -BWeSn+t"arg(B north) [deg]"  -X11
awk '{print($1,$2,$7)}' $infile | gmt surface -R$wesn -I$di -Ggrd.grd -T0
gmt grdimage  grd.grd -C -R$wesn
gmt grdcontour topo.grd -C50 -L-40/40 -W1

#[by] UP
gmt basemap -R$wesn -JX10/10 -Bxa50+l"Easting[km]" -Bya50 -BWeSn+t"arg(B up) [deg]" -X11
