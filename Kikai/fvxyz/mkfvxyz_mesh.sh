...
make
cd -
# ok up to here 2026.07.22

fldr=../mesh # 2024.03.07 Tatkuo Minami
meshctl=${fldr}/mesh.ctl            # 2024.03.07 Tatkuo Minami
...
${src}/mkvxyzfile.exe # input is u_vxyz_mesh and v_vxyz_mesh, generate vxyz_mesh
