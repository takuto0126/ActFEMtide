! Takuto Minami
! coded on 2022.10.24
program change_model2cond_surf
use param
use mesh_type
use cond_type      !  ../common/m_param.f90
implicit none
type(param_cmod) :: m_param_cond        !  ../common/m_cond_type.f90
type(mesh)       :: h_mesh
...
use cond_type
implicit none
type(param_cmod),intent(out) :: m_param ! m_cond_type.f90
integer(4)       :: input=5,i
