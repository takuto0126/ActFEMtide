...
type param_post
 ...
 character(50) :: m0condfile
 character(50) :: dmcondfile
 !#
 character(50) :: connectfile ! 2018.10.24
 character(50) :: m0modelfile ! 2018.10.24
 character(50) :: dmmodelfile ! 2018.10.24
 !#
 character(50) :: outputfile(5) ! 2018.10.24
 real(8)       :: xyprof(2)
 integer(4)    :: nlayer
...
type param_slice ! 2017.12.20
 ...
 integer(4)    :: nmodelfile ! 2017.12.21
 character(50),allocatable,dimension(:) :: modelfile ! 2017.12.21
 !#
 character(50),allocatable,dimension(:) :: outpolygonhead
...
if ( ifileflag .eq. 0 .or. ifileflag .eq. 2 ) then !==! 2018.03.12 condfile
...
else if ( ifileflag .eq. 1 .or. ifileflag .eq. 3) then ! 2018.03.19 modelfile
