...
real(8) :: omega
!## Output Files ##############################################
!character(50) :: outfilebx(1:2)=(/"bxana1.dat","bxana2.dat"/)
!character(50) :: outfileby(1:2)=(/"byana1.dat","byana2.dat"/)
!character(50) :: outfilebz(1:2)=(/"bzana1.dat","bzana2.dat"/)
!character(50) :: outfileex(1:2)=(/"exana1.dat","exana2.dat"/)
!character(50) :: outfileey(1:2)=(/"eyana1.dat","eyana2.dat"/)
!## Observation info ###########################################
!real(8),parameter :: xmin=-1000.d0
!real(8),parameter :: xmax=7000.d0
!real(8),parameter :: dx=20.d0       ! [m]
!real(8),parameter :: ymin=-1000.d0 ! [m] minimum x coordinate
!real(8),parameter :: ymax=7000.d0  ! [m] maximum x coordinate
!real(8),parameter :: dy=20.d0       ! [m] distance between observation points
!###############################################################
! global variables
