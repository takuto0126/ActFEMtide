! copied from ../solver/solvePARDISO.f90 2021.12.25
! modified for multiple source on 2017.07.11
! Coded by T.M. on May 13, 2016
! based on pardiso_sym_f90.f90
!PROGRAM pardiso_sym_f90
!   INCLUDE 'mkl_pardiso.f90' ! included already at m_solvePARDISOinv.f90 2021.12.25
   module solvePARDISO_2D ! 2021.12.25
      contains               ! 2021.12.25
