...
xmin = xyzminmax(1) - 1. ! 2024.03.11
xmax = xyzminmax(2) + 1. ! 2024.03.11
ymin = xyzminmax(3) - 1. ! 2024.03.11
ymax = xyzminmax(4) + 1. ! 2024.03.11
zmin = xyzminmax(5) - 1. ! 2024.03.11
zmax = xyzminmax(6) + 1. ! 2024.03.11
nx   = glist%nx
ny   = glist%ny
nz   = glist%nz
...
do ii=1,h_mesh%ntet
 ...
 !if(mod(ii,1000) == 0 ) write(*,*) ii,"/",h_mesh%ntet ! 2024.03.07
...
if ( ngroup .ge. 1 ) write(*,'(a)') " ---" ! 2024.03.16
do j=1,ngroup
 write(*,'(a,i5,a,i10)') " # of Tetrahedron group",j, " = ",icount(j)
end do
