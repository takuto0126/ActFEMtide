...
subroutine forward_inv(A,h_mesh,l_line,doftot,nsr,bs,omega,sparam,g_param,&
			&    g_param_inv,g_cond,PT,ut) ! 2017.07.14
use mesh_type
use iccg_var_takuto
use line_type
use param
...
CALL INITIALIZE(A,b_vec,bs,doftot,nsr)       ! set 0 for all, see m_iccg_var_takuto.f90
...
CALL COPY_UL_ICCG12(A) ! see m_iccg_var_takuto.f90 2021.09.16
...
use  param
use  param_inv       ! 2017.07.13
use  constants,   only:pi,dmu,epsilon          ! see m_constants.f90, 2017.07.13
...
complex(8)                          :: sigma,sigma0  ! 2018.03.20 real -> complex
...
!#
  ...
  sigma = sigma + iunit*omega*epsilon  ! 2018.03.20
