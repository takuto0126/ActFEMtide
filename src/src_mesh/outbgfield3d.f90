!# Coded on 2016.09.28
subroutine outbgfield3d(g_param)
use param
implicit none
type(param_forward),intent(in)     :: g_param
character(50) :: header3d,fieldfile,pregeo
...
fieldfile  = header3d(1:len_trim(header3d))//"_field.geo"
