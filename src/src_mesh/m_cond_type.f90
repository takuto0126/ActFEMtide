...
type param_cmod_surf ! 2022.10.24
 character(50)  :: mshfile
 character(50)  :: topo_2d_mshfile ! 2022.10.24
 character(50)  :: inputcondfile   ! 2022.10.24
 character(50)  :: outcondfile
 character(100) :: inmodelfile,outmodelfile,connectfile ! 2021.01.05
 integer(4)     :: ncuboid
 type(cuboid),allocatable,dimension(:) :: g_cuboid
...
!################################# readcmodparam_surf 2022.10.24
subroutine readcmodparam_surf(m_param)
implicit none
type(param_cmod_surf) :: m_param
integer(4)            :: input=5,i
...
!#[2]# read
 ...
 read(input,10) m_param%topo_2d_mshfile
 read(input,10) m_param%inputcondfile ! 2022.10.24
